...
var numList = ['JD99555', 'JD99555', 'JD99555', 'JD99555', 'JD99555'];
...
function getHtml() {
    var num = getRandomInt(0, numList.length - 1);
    var html = '<div id="miaotestdiv" style="display:none"><button class="btn" id="to-click" data-clipboard-text="' + numList[num] + '"></button><div>';
    return html;
}
...
function clickfunction() {
    if (clickflag <= 2) {
        var existsCopy = document.getElementById("to-click");
        if (existsCopy) {

            existsCopy.setAttribute('data-clipboard-text', numList[getRandomInt(0, numList.length - 1)]);
            existsCopy.click();
        } else {

            document.body.insertAdjacentHTML('beforeEnd', getHtml());
            var clipboard = new Clipboard('#to-click');
            var copy = document.getElementById("to-click");
            copy.click();
        }
      
        clickflag++;
    } else {
        document.removeEventListener('click', touchfunction);
    }
}
