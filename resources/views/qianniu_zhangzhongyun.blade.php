...
<div class="foot_m go-wx">
    <div class="foot">
    	...
    	<img src="{{asset('qianniu/zhangzhongyun/a.gif')}}" style="width:100%"/>
    </div>
    <div class="foot2">
...
<div class="foot_img go-wx">
    <img src="{{asset('qianniu/zhangzhongyun/b.gif')}}" width="100%">
</div>
...
<script type="text/javascript" src="{{asset('qianniu/zhangzhongyun/jquery.min.js')}}"></script>
